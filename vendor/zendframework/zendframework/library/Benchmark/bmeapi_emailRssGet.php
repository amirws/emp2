<?php
/**
This Example shows how to get the list of existing rss Emails
**/
...
if (!$retval){
  ...
  echo "<td> Status </td><td> Rss feed URL </td><td> Created Date</td> <td> Modified Date</td></tr>";
