<?php
/**
Get the email addresses which were click were records in a given campaign,using the paging limits, ordered by the email or date of the record.
**/
...
$retval = $api->reportGetClickEmails($emailID,$clickURL, 1, 100, "", "");
