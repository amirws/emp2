...
return array(
            ...
            'usuario' => array(
                ...
                'child_routes' => array(
                    'default' => array(
                        'type'    => 'Segment',
                        'options' => array(
                            'route'    => '/[:controller[/:action][/:id]][/:validar]',
                            'constraints' => array(
                                'controller' => '[a-zA-Z][a-zA-Z0-9_-]*',
                                'action'     => '[a-zA-Z][a-zA-Z0-9_-]*',
                                'id'     => '[0-9_-]*',
                                'validar'=>'[a-zA-Z][a-zA-Z0-9_-]*',
                            ),
                            'defaults' => array(
                            ),
                        ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Usuario\Controller\Cpanel' => 'Usuario\Controller\CpanelController',
            'Usuario\Controller\Usuario' => 'Usuario\Controller\UsuarioController',
            'Usuario\Controller\Nueva' => 'Usuario\Controller\NuevaController',
            'Usuario\Controller\Validar' => 'Usuario\Controller\ValidarController',
        ),
    ),
    'view_manager' => array(
